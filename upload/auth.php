...
if (strpos($_COOKIE['memberof'], 'Lawyers') !== false or strpos($_COOKIE['memberof'], 'WireGuardAdmins') !== false){
...
if(isset($_POST['username']) && isset($_POST['password'])){
    ...
    if ($bind) {
        ...
        for ($i=0; $i<$info["count"]; $i++)
        {
            ...
            if (strpos($rows, 'Lawyers') !== false or strpos($rows, 'WireGuardAdmins') !== false){
                header('Location: main_page.php');
            }else{
                header('Location: main_page_view.php');
            } 
                ...
                <a href="/" class="back-btn">Выйти</a></div>'; 
            }
}
?>
