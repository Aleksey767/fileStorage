...
<a href='download.php'><div class='download'><img src='icon_downl.png'><a href='download.php'>Upload new file</div></a></a>
...
' . $name . '
<div class="btns"><a href="http://docs.google.com/viewer?url=http://your_domen' . $dir . '/' . $file . '"  class="down_btn">Открыть</a> 
<a class="del_btn" href="main_page.php?delete=' . $file . '">Удалить</a><br></div>
</div>';
            } else {
                echo '<div  class="item"><img src="icon.png" alt="icon">
' . $name . '
<div class="btns"><a href="' . $dir . '/' . $file . '"  class="down_btn">Opend</a> 
<a class="del_btn" href="main_page.php?delete=' . $file . '">Delete</a><br></div>
</div>';
            }
        }
